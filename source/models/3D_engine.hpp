...
public:
    ...
    /**
     * @brief Создание новой камеры
     *
     * Создает новую камеру с параметрами по-умолчанию
     */
    void SpawnCamera();
     ...
     *
     * Гарантируется, что сначала обновится список объектов, а потом выбранный объект
     *
     * @param[in] path Путь
     */
